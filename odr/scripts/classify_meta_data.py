...
def main():
	...
	unlabelled_data_dir = '/home/kevin/catkin_ws/data/unlabelled'

	labelled_data_dir = '/home/kevin/catkin_ws/data/labelled'

	gp_labelled_data_dir = '/home/kevin/catkin_ws/data/gp_labelled'
	...
	for foldi in folder:
		...
		instance_i, files_i = extract_feature( os.path.join(unlabelled_data_dir, folderi) ) 
		...
		for sp, idx in zip(sorted_probs,index):
			if sp > threshold:
				src = os.path.join(unlabelled_data_dir, foldi, files[idx])
				dst = os.path.join(gp_labelled_data_dir, foldi, files[idx])
				print src
				print dst
				shutil.move(src, dst)

				src = '{}/{}/{}.{}'.format(unlabelled_data_dir, foldi, os.path.splitext(files[idx])[0], 'mat')
