...
def cnn(split):
    ...
    pydata_params = dict(dataset_dir='/home/kevin/dataset/processed_data', variable='depth_map', split=split, mean=(2),
            seed=1337, batch_size=128, img_size=(250,250))
    if split == 'deploy':
    ...
    # the base net
    n.conv1, n.relu1 = conv_relu("conv1", n.img, 128, ks=5, stride=2, pad=2)
