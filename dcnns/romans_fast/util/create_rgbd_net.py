...
def cnn(split):
    ...
    pydata_params = dict(dataset_dir='/home/kevin/dataset/rgbd', split=split, mean=(104.00698793, 116.66876762, 122.67891434),
            seed=1337, batch_size=32, img_size=(224,224))
    if split == 'deploy':
    ...
    # the vgg 16 base net
    n.conv1_1, n.relu1_1 = conv_relu("conv1_1", n.rgb, 64, pad=1)
    n.conv1_2, n.relu1_2 = conv_relu("conv1_2", n.relu1_1, 64)
    n.rgb_pool1 = max_pool(n.relu1_2)

    n.conv2_1, n.relu2_1 = conv_relu("conv2_1", n.rgb_pool1, 128)
    n.conv2_2, n.relu2_2 = conv_relu("conv2_2", n.relu2_1, 128)
    n.rgb_pool2 = max_pool(n.relu2_2)

    n.conv3_1, n.relu3_1 = conv_relu("conv3_1", n.rgb_pool2, 256)
    n.conv3_2, n.relu3_2 = conv_relu("conv3_2", n.relu3_1, 256)
    n.conv3_3, n.relu3_3 = conv_relu("conv3_3", n.relu3_2, 256)
    n.rgb_pool3 = max_pool(n.relu3_3)

    n.conv4_1, n.relu4_1 = conv_relu("conv4_1", n.rgb_pool3, 512)
    n.conv4_2, n.relu4_2 = conv_relu("conv4_2", n.relu4_1, 512)
    n.conv4_3, n.relu4_3 = conv_relu("conv4_3", n.relu4_2, 512)
    n.rgb_pool4 = max_pool(n.relu4_3)

    n.conv5_1, n.relu5_1 = conv_relu("conv5_1", n.rgb_pool4, 512)
    n.conv5_2, n.relu5_2 = conv_relu("conv5_2", n.relu5_1, 512)
    n.conv5_3, n.relu5_3 = conv_relu("conv5_3", n.relu5_2, 512)
    n.rgb_pool5 = max_pool(n.relu5_3)

    # fully conv
    n.rgb_fc6, n.rgb_relu6 = fc_relu(n.rgb_pool5, 4096, lr1=1, lr2=2)
    n.rgb_drop6 = L.Dropout(n.rgb_relu6, dropout_ratio=0.9, in_place=True)
    n.rgb_fc7, n.rgb_relu7 = fc_relu(n.rgb_drop6, 4096, lr1=1, lr2=2)
    n.rgb_drop7 = L.Dropout(n.rgb_relu7, dropout_ratio=0.9, in_place=True)

    #---------------------------------Depth-Net---------------------------------------#

    # the base net
    n.conv1, n.relu1 = conv_relu("conv1", n.depth, 128, ks=5, stride=2, pad=2)
    n.depth_pool1 = max_pool(n.relu1, ks=3)
    n.norm1 = L.LRN(n.depth_pool1, lrn_param=dict(local_size=5, alpha=0.0005, beta=0.75, k=2))

    n.conv2, n.relu2 = conv_relu("conv2", n.norm1, 256, ks=5, stride=1, pad=2)
    ...
    n.conv4, n.relu4 = conv_relu("conv4", n.depth_pool3, 512, ks=3, pad=1, group=1)

    n.conv5, n.relu5 = conv_relu("conv5", n.relu4, 512, ks=3, pad=1, group=1)
    
    n.depth_pool5 = max_pool(n.relu5, ks=3)

    n.depth_fc6, n.depth_relu6 = fc_relu(n.depth_pool5, 4096, lr1=1, lr2=2)   
    n.depth_drop6 = L.Dropout(n.depth_relu6, dropout_ratio=0.9, in_place=True)
    n.depth_fc7, n.depth_relu7 = fc_relu(n.depth_drop6 , 4096, lr1=1, lr2=2)
    n.depth_drop7 = L.Dropout(n.depth_relu7, dropout_ratio=0.9, in_place=True)
