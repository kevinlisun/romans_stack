...
def compute_classification_error(net, save_dir, dataset, layer, gt):
    ...
    return accuracy_rgb/len(dataset), accuracy_depth/len(dataset), loss_rgb/len(dataset), loss_depth/len(dataset), confusion_mat/(np.tile(confusion_mat.sum(1),(51,1))).T
