...
net1 = caffe.Net('/home/kevin/models/model_net/heavy/deploy.prototxt', 
                '/home/kevin/models/rgbd_net/finetuned_depth.caffemodel', 
                caffe.TEST)
...
net2 = caffe.Net('train.prototxt', 
                '/home/kevin/models/rgbd_net/pretrained_model.caffemodel', 
                caffe.TEST)
params2 = ['conv1', 'conv2', 'conv3', 'conv4', 'conv5', 'depth_fc6', 'depth_fc7']
...
net2.save('/home/kevin/models/rgbd_net/stage1_model.caffemodel')
