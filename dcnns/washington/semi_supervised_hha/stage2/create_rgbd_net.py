...
def cnn(split):
    ...
    # the base net
    # the vgg 16 base net
    n.conv1_1d, n.relu1_1d = conv_relu("conv1_1d", n.depth, 64, pad=1, lr1=0, lr2=0)
    n.conv1_2d, n.relu1_2d = conv_relu("conv1_2d", n.relu1_1d, 64, lr1=0, lr2=0)
    n.depth_pool1 = max_pool(n.relu1_2d)

    n.conv2_1d, n.relu2_1d = conv_relu("conv2_1d", n.depth_pool1, 128, lr1=0, lr2=0)
    n.conv2_2d, n.relu2_2d = conv_relu("conv2_2d", n.relu2_1d, 128, lr1=0, lr2=0)
    n.depth_pool2 = max_pool(n.relu2_2d)

    n.conv3_1d, n.relu3_1d = conv_relu("conv3_1d", n.depth_pool2, 256, lr1=0, lr2=0)
    n.conv3_2d, n.relu3_2d = conv_relu("conv3_2d", n.relu3_1d, 256, lr1=0, lr2=0)
    n.conv3_3d, n.relu3_3d = conv_relu("conv3_3d", n.relu3_2d, 256, lr1=0, lr2=0)
    n.depth_pool3 = max_pool(n.relu3_3d)

    n.conv4_1d, n.relu4_1d = conv_relu("conv4_1d", n.depth_pool3, 512, lr1=0, lr2=0)
    n.conv4_2d, n.relu4_2d = conv_relu("conv4_2d", n.relu4_1d, 512, lr1=0, lr2=0)
    n.conv4_3d, n.relu4_3d = conv_relu("conv4_3d", n.relu4_2d, 512, lr1=0, lr2=0)
    n.depth_pool4 = max_pool(n.relu4_3d)

    n.conv5_1d, n.relu5_1d = conv_relu("conv5_1d", n.depth_pool4, 512, lr1=0, lr2=0)
    n.conv5_2d, n.relu5_2d = conv_relu("conv5_2d", n.relu5_1d, 512, lr1=0, lr2=0)
    n.conv5_3d, n.relu5_3d = conv_relu("conv5_3d", n.relu5_2d, 512, lr1=0, lr2=0)
