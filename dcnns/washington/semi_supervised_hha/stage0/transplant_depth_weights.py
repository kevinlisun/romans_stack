...
net2 = caffe.Net('train.prototxt', 
                '/home/kevin/models/rgbd_net/model.caffemodel', 
                caffe.TEST)
params2 = ['conv1_1d', 'conv1_2d', 'conv2_1d', 'conv2_2d', 'conv3_1d', 'conv3_2d', 'conv3_3d', 'conv4_1d', 'conv4_2d', 'conv4_3d', 'conv5_1d', 'conv5_2d', 'conv5_3d', 'depth_fc6', 'depth_fc7']
