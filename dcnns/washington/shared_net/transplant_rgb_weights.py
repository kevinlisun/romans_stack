...
net1 = caffe.Net('/home/kevin/models/alex_net/deploy.prototxt', 
                '/home/kevin/models/alex_net/model.caffemodel', 
                caffe.TEST)
params1 = ['conv3', 'conv4', 'conv5']
...
net2 = caffe.Net('train.prototxt', 
                '/home/kevin/models/alex_net/model.caffemodel',
                caffe.TEST)
params2 = [ 'depth_conv3', 'depth_conv4', 'depth_conv5' ]
...
net2.save('/home/kevin/models/shared_net/rgb_pretrained_model.caffemodel')
