...
def cnn(split):
    n = caffe.NetSpec()
    pydata_params = dict(dataset_dir='/home/kevin/dataset/rgbd_dataset_eval', split=split, mean=(104.00698793, 116.66876762, 122.67891434),
            seed=1337, batch_size=48, img_size=(224,224))
    if split == 'deploy':
    ...
    n.rgb_conv3, n.rgb_relu3 = conv_relu("conv3", n.rgb_norm2, 384, ks=3, pad=1, lr1=1, lr2=2)
    n.rgb_conv4, n.rgb_relu4 = conv_relu("conv4", n.rgb_relu3, 384, ks=3, pad=1, group=2, lr1=1, lr2=2)

    n.rgb_conv5, n.rgb_relu5 = conv_relu("conv5", n.rgb_relu4, 256, ks=3, pad=1, group=2, lr1=1, lr2=2)
    ...
    n.depth_conv3, n.depth_relu3 = conv_relu("conv3", n.depth_norm2, 384, ks=3, pad=1, lr1=1, lr2=2)
    n.depth_conv4, n.depth_relu4 = conv_relu("conv4", n.depth_relu3, 384, ks=3, pad=1, group=2, lr1=1, lr2=2)

    n.depth_conv5, n.depth_relu5 = conv_relu("conv5", n.depth_relu4, 256, ks=3, pad=1, group=2, lr1=1, lr2=2)
